...
import com.test.csv_assignment.details.ParticipantsDetails;
...
public class ExcelOperator {
	...
	public void excelFilewriter(String fileName, List list) throws Exception {
        ...
        try {
                ...
                ListIterator<SampleCRF> participantsListIterator = list.listIterator();
		        ...
		        while (participantsListIterator.hasNext()) {
		        	...
		        	SampleCRF sampleCRF = participantsListIterator.next();
